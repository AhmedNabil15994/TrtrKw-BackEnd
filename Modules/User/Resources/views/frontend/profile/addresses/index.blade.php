                            ...
                            <form class="mt-20"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country_id"
                                           value="{{ $address->state->city->country->translate(locale())->title }}"
                                           disabled>
                                </div>
                                <div class="form-group">
                                    <label>{{__('user::frontend.addresses.form.city')}}</label>
                                    <input type="text" name="city_id"
                                           value="{{ $address->state->city->translate(locale())->title }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label>{{__('user::frontend.addresses.form.state_name')}}</label>
                                    <input type="text" name="state_id"
                                           value="{{ $address->state->translate(locale())->title }}" disabled>
