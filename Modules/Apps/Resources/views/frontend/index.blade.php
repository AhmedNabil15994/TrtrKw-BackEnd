    ...
    <div class="home-slider-container">
        <div class="owl-carousel home-slides">
            ...
            @foreach($sliders as $k => $slider)
                <div class="item">
                    <img src="{{ url($slider->image) }}" alt="{{ $slider->translate(locale())->title }}"/>
                </div>
            @endforeach
                    ...
                    @foreach($categories as $k => $category)
                        <div class="product-grid">
                            ...
                            <div class="product-content">
                                <h3 class="title">
                                    <a href="{{ route('frontend.categories.products', $category->slug) }}">{{ $category->translate(locale())->title }}</a>
                                </h3>
                            </div>
                        </div>
                    @endforeach
                ...
                <div class="owl-carousel products-slider">
                    ...
                    @foreach($featuredProducts as $k => $prd)
                        <div class="product-grid">
                            ...
                            <div class="product-content">
                                <h3 class="title">
                                    <a href="{{ route('frontend.products.index', $prd->slug) }}">{{ $prd->translate(locale())->title }}</a>
                                </h3>
