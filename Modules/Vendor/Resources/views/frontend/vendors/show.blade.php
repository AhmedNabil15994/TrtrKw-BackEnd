                            ...
                            @foreach($categories as $k => $category)
                                <li class="nav-item">
                                    <a class="nav-link {{ activeCategoryTab($category, $k, 'active') }}"
                                       ...
                                       aria-controls="tab{{$k}}"
                                       aria-selected="{{ activeCategoryTab($category, $k, true) }}">{{ $category->translate(locale())->title }}</a>
                                </li>
                            @endforeach
                                                ...
                                                <div class="product d-flex align-items-center">
                                                    <div class="media-body">
                                                        <a class="product-name theme-color-hover"
                                                           href="{{ url(route('frontend.products.index', [$vendorObject->translate(locale())->slug, $product->translate(locale())->slug,])) }}">{{ $product->translate(locale())->title }}</a>
