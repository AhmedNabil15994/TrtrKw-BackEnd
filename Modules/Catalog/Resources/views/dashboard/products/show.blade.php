                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>{{ $product->vendor->translate(locale())->title }}</td>
                            </tr>
                            <tr>
                    ...
                    <div class="col-md-4">
                        ...
                        <ul>
                            @foreach($product->categories as $k => $item)
                                <li>{{ $item->translate(locale())->title }}</li>
                            @endforeach
                        </ul>
                    </div>
                @endif
                        ...
                        <ul>
                            @foreach($product->addOns as $k => $item)
                                <li>
                                    <a href="javascript:;"
                                       data-toggle="modal"
                                       data-target="#modal-{{ $item->id }}">{{ $item->translate(locale())->name }}</a>
                                        ...
                                        <td>
                                            <ul>
                                                @foreach($item->productValues as $value)
                                                    <li>
                                                        {{ $value->productOption->option->translate(locale())->title }}
