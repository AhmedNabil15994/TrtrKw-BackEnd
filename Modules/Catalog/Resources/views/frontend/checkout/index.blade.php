            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-muted" aria-current="page">
                        {{ __('catalog::frontend.checkout.index.title') }}</li>
                </ol>
            </nav>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="cart-inner">
                                            ...
                                            <label class="" for="checkoutSelectedAddress-{{ $address->id }}">
                                                ...
                                                <span class="d-inline-block right-side text-secondary">
                                                    {{ __('catalog::frontend.checkout.address.form.mobile') }} :
                                                                ...
                                                                <span
                                                                    class="d-inline-block left-side"> {{ $address->mobile }} </span>
                                                            </p>
                                                        @endif
                            ...
                            <h2 class="cart-title"># {{ $shippingCompany->translate(locale())->name }}</h2>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="exampleModalLongTitle"> {{ __('user::frontend.addresses.create.title') }}
                        </h5>
