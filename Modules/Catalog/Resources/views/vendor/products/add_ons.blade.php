    ...
    <script>
        ...
        function appendNewOptionRow(data) {
            ...
            var newRow = `<tr id="addOnsRow-${data.id}">
                                            ...
                                            <td>
                                            <a href="javascript:void(0)" class="btn btn-primary"
                                               onclick="editMasterOptions('row', ${data.id})" title="{{__('apps::vendor.general.edit_btn')}}"><i class="fa fa-edit"></i></a>

                                            <a href="javascript:void(0)" class="btn btn-warning"
                                               onclick="openAddOnsDetails('row', ${data.id})" title="{{__('catalog::vendor.products.form.add_ons.show')}}"><i class="fa fa-eye"></i></a>

                                            <a href="javascript:void(0)" class="btn btn-danger"
                                               onclick="deleteMasterOptions(${data.id}, 'db')" title="{{__('apps::vendor.general.delete_btn')}}"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>`;
        ...
        function openAddOnsDetails(flag = '', rowId, data = {}) {
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalLabel-${data.id}">{{ __('catalog::vendor.products.form.tabs.add_ons') }}</h5>
            ...
            for (let $value of data.add_on_options) {
                ...
                <tr>
                   ...
                   <td>${$value.option}</td>
                   <td>${$value.price}</td>
                   <td>${$value.default == null ? "{{__('apps::vendor.general.no_btn')}}" : "{{__('apps::vendor.general.yes_btn')}}"}</td>
                </tr>
                `;
            }
            modal += `</tbody>
            ...
            <button type="button" class="btn btn-secondary" data-dismiss="modal">{{__('apps::vendor.general.close_btn')}}</button>
            </div>
            </div>
            </div>
          </div>`;
